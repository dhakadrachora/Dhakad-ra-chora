      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300 font-mono text-[10px] uppercase tracking-widest font-bold">
            <Zap className="w-3.5 h-3.5" /> High-Performance Offers
          </div>
          ...
          <p className="font-sans text-zinc-400 text-sm sm:text-base">
            Eye-catching graphics, optimized SEO architecture, and lightning-speed code that converts casual window shoppers into high-value repeat clients.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map((service, index) => {
            ...
            const IconComponent = dynamicIconMap[service.icon] || Search;
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="group relative flex flex-col justify-between p-6 sm:p-8 rounded-2xl bg-[#0e0f18]/60 border border-zinc-900 hover:border-purple-500/20 shadow-2xl overflow-hidden transition-all duration-300"
              >
