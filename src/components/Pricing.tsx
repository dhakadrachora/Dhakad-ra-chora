...
export default function Pricing({
  ...
  const PACKAGES = language === "en" ? [
    ...
    {
      id: "pack-basic",
      badge: "प्रारंभिक शुरुआत",
      name: "स्टार्टर स्पार्क प्लान",
      description: "बेसिक ब्लॉग्स या व्यक्तिगत पोर्टफोलियो के लिए आदर्श जो ऑर्गेनिक रीच चाहते हैं।",
      price: "$99",
      features: [
        "1x ब्लॉगर कस्टमाइज़ेशन या सिंपल लैंडिंग पेज",
        "3x हाई-CTR यूट्यूब थंबनेल्स",
        "2x एसईओ अनुकूलित लेख (1000 शब्द प्रत्येक)",
        "गूगल सर्च कंसोल बुनियादी सेटअप",
        "24/7 ईमेल और चैट सहायता सेवा"
      ],
      deliveryTime: "3-5 दिन",
      revisions: "असीमित",
      ctaText: "स्टार्टर पैक शुरू करें",
      isPopular: false
    },
    {
      id: "pack-std",
      badge: "मार्केट डोमिनेशन",
      name: "प्रो डिजिटल आर्किटेक्ट",
      description: "तेजी से बढ़ते चैनलों या एक्टिव यूट्यूब क्रिएटर्स के लिए बिल्कुल सही प्लान।",
      price: "$249",
      features: [
        "एलिमेंटर प्रो के साथ फुल वर्डप्रेस सेटअप",
        "8x प्रीमियम क्लिक-मैग्नेट यूट्यूब थंबनेल्स",
        "5x हाई-रैंक ब्लॉग आर्टिकल्स (एसईओ कीवर्ड्स के साथ)",
        "पूर्ण ऑन-पेज एसईओ ऑडिट और स्पीड ऑप्टिमाइज़ेशन",
        "बुनियादी गूगल एनालिटिक्स (GA4) ट्रैकिंग सेटअप"
      ],
      deliveryTime: "7-10 दिन",
      revisions: "असीमित",
      ctaText: "प्रोफेशनल बनें",
      isPopular: true
    },
    {
      id: "pack-prem",
      badge: "सर्वोच्च गति",
      name: "एलीट ग्रोथ मशीन",
      description: "हाई-कन्वर्टिंग ग्लासमोर्फिक डिज़ाइन्स और बेहतरीन एसईओ रैंकिंग सिस्टम।",
      price: "$499",
      features: [
        "सुपरफास्ट ग्लासमोर्फिक Vite/React लैंडिंग पेज",
        "1 महीने के लिए असीमित यूट्यूब थंबनेल्स और सोशल कवर्स",
        "10x एसईओ कंटेंट ब्लॉग आर्टिकल्स (टॉपिकल कवरेज)",
        "एडवांस JSON-LD स्कीमा और कोर वेब वाइटल्स स्पीड फिक्स",
        "कस्टम ChatGPT/Claude प्रॉम्प्ट ऑटोमेशन फ्लो सेटअप"
      ],
      deliveryTime: "14-20 दिन",
      revisions: "असीमित",
      ctaText: "एलीट स्केल अपनाएं",
      isPopular: false
    },
    {
      id: "pack-ent",
      badge: "अनंत कस्टमाइज़ेशन",
      name: "कस्टम एंटरप्राइज हब",
      description: "बड़े व्यवसायों और पोर्टल्स के लिए जिन्हें एडवांस फीचर्स की जरूरत है।",
      price: "$999",
      features: [
        "जटिल वर्डप्रेस/शॉपिफ़ाई मल्टि-फंक्शनल वेब प्लेटफॉर्म",
        "संपूर्ण डिजिटल ब्रांडिंग एसेट्स सूट (थंबनेल और यूआई ग्राफिक्स)",
        "थोक एसईओ कंटेंट कोडिंग (20+ स्ट्रैटेजिक आर्टिकल्स)",
        "एडवांस एसईओ प्रतिस्पर्धी विश्लेषण और रैंकिंग प्रभुत्व",
        "पूर्ण ऑटोमेशन इंटीग्रेशन और कस्टम वेबहुक कनेक्शन"
      ],
      deliveryTime: "आवश्यकतानुसार",
      revisions: "असीमित",
      ctaText: "कस्टम हब प्राप्त करें",
      isPopular: false
    }
  ];
